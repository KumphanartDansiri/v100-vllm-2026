...
6. [Model pages](docs/06_model_results_template.md) — one per family (9). The **featured Qwen3.5 pair** (full precision×TP / TTFT / faithfulness profile in **[Ch.5](docs/05_fp8_plugin.md)**):
